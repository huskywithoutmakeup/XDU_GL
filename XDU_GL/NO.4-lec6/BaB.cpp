...
void DrawBezier3D(int n, Point P[])
{
    ...
    for (i = 0; i < 100; i++)
    {
        ...
        if (i == 0)
            cout << "Q1(0)=(" << p.x << "," << p.y << "," << p.z << ")" << endl;
        else if (i == 33)
            cout << "Q1(1/3)=(" << p.x << "," << p.y << "," << p.z << ")" << endl;
        else if (i == 67)
            cout << "Q1(2/3)=(" << p.x << "," << p.y << "," << p.z << ")" << endl;
        else if (i == 99)
            cout << "Q1(1)=(" << p.x << "," << p.y << "," << p.z << ")" << endl;
...
void DrawB3D(int n, Point P[])
{
    ...
    for (i = 0; i < 100; i++)
    {
        ...
        if (i == 0)
            cout << "Q2(0)=(" << p.x << "," << p.y << "," << p.z << ")" << endl;
        else if (i == 33)
            cout << "Q2(1/3)=(" << p.x << "," << p.y << "," << p.z << ")" << endl;
        else if (i == 67)
            cout << "Q2(2/3)=(" << p.x << "," << p.y << "," << p.z << ")" << endl;
        else if (i == 99)
            cout << "Q2(1)=(" << p.x << "," << p.y << "," << p.z << ")" << endl;
        glVertex3f(p.x, p.y, p.z);
    }
    cout << "" << endl;
    glEnd();
